        ...
        <div className="max-w-lg mx-auto  bg-white  rounded-lg shadow-md px-4 py-6 md:p-8 flex flex-col items-center">
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3">
            <div className="flex items-start flex-col justify-start gap-2">
              <label htmlFor="title" className="text text-mainBreakColor  mr-2">
                Title:
              </label>
              <MyInput
                type="text"
            ...
            <div className="relative flex items-start flex-col justify-start gap-2">
              <label htmlFor="image" className="text text-mainBreakColor  mr-2">
                Image:
              </label>
              <div className="upload w-full relative items-center gap-2  font-semibold flex px-2 py-1.5 border border-gray-300 rounded-md text-sky-500/80 cursor-pointer">
                <LuImagePlus className="text-sky-400 text-2xl " /> Upload Image
                <input
              ...
              {image?.name && (
                ...
                >
                  <img
                    onClick={() =>
                      dispatch(
                        openImageLightBox({ image: URL.createObjectURL(image) })
                      )
                    }
            ...
            <div className=" flex items-start flex-col justify-start gap-2">
              <label htmlFor="price" className="text text-mainBreakColor  mr-2">
                Price:
              </label>
              <MyInput
                id="price"
            ...
            <div className=" flex items-start flex-col justify-start gap-2">
              <label htmlFor="rate" className="text text-mainBreakColor  mr-2">
                Rate:
              </label>
              <MyInput
                id="rate"
            ...
            <div className=" flex items-start flex-col justify-start gap-2">
              <label htmlFor="count" className="text text-mainBreakColor  mr-2">
                Count:
              </label>
              <MyInput
                id="count"
